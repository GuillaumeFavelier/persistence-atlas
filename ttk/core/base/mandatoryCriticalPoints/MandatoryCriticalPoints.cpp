...
MandatoryCriticalPoints::MandatoryCriticalPoints() {
  ...
  outputCriticalPointProbability_ = NULL;
...
int MandatoryCriticalPoints::buildSubTrees(){
  ...
  #ifdef TTK_ENABLE_OPENMP
  #pragma omp parallel sections num_threads(threadNumber_) if(isParallel_)
  #endif
  {
    #ifdef TTK_ENABLE_OPENMP
    #pragma omp section
...
//   #pragma omp parallel num_threads(threadNumber_)
  ...
  #ifdef TTK_ENABLE_OPENMP
  #pragma omp parallel num_threads(threadNumber_) if(isParallel_)
  #endif
  {
